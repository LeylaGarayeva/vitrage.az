<div class="ban-top" style="background-color: #b2907d;padding:10px 0px">
	<div class="container">
			...
			<nav class="navbar navbar-default">
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list" style="margin-left: 10%">

						<li class="dropdown menu__item">
							<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">NEW ARRIVALS  </span></a>
								<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%;">
									<div class="row">
									...
									<br>
									<div class="col-sm-6 multi-gd-img multi-gd-text" style="width: 65% !important;padding: inherit;">
										<a href="womens.html"><img src="img/20707750_10214358120486054_410953276_n.png" alt=" "/></a>
										
                            
			                            <a id="link" href="#">Just in</a>
			                            <h4 id="idHeader">Nomination <br> Pendants</h4>
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">BRANDS    </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">WOMAN  </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MAN   </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
							<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">KIDS   </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
						<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SALE    </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
							<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">PROMO </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<!--  -->
							<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">LEVATAGROUP </span></a>
							<ul class="dropdown-menu multi-column columns-3"  style="margin-top: 6%; ">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
									<br>
					...
					<li>
						<div class="src_div">
							<p id="p"><input type="" name="" ></p>
					        <i class="fa fa-search" aria-hidden="true" id="i"></i>
...
a.callbacks_nav.callbacks1_nav.prev {
	background: transparent url("../images/themes.html") no-repeat 0px 0px;
  left: -3.1%;
}
.callbacks_nav.next {
	background: transparent url("../images/themes.html") no-repeat -46px 0px;
  left: 100%;
}
